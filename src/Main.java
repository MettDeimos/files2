...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String saveDirPath = "C:\\Users\\Public\\homework\\Java core\\Games";
    ...
    public static void saveAllGameProgressObjects(GameProgress[] gameProgress, String saveDirPath, List<String> allSaves) {
        for (int i = 0; i < gameProgress.length; i++) {
            ...
            System.out.println("Создание файла сохранений \"" + saveFilePath + "\"");
        }
    }
    ...
    public static void deleteSaveFiles(List<String> allSaves) {
        for (String saveFilePath : allSaves) {
            System.out.println("Удаляние файла \"" + saveFilePath + "\"");
